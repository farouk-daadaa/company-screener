...
import com.nomow.company_screener.exception.AiServiceException;
...
public class AiService {
    ...
    public String ask(Company company, String question) {
        ...
        try {
            ...
            throw new AiServiceException("AI service is currently unavailable. Please try again later.", ex);
        }
    }
}